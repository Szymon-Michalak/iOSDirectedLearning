...
- [iOS Development](#ios-development)
  ...
  - [🖊️ **Recreate**](#-recreate)
  - [🖊️ **iOS Example**](#-ios-example)
  - [🖊️ **Create with Swift**](#-create-with-swift)
...
- [Developer Advocacy and Firebase](#developer-advocacy-and-firebase)
  - [🖊️ **Peter Friese - Developer Advocate**](#-peter-friese---developer-advocate)
- [UIKit](#uikit)
...
- [Xcode](#xcode)
  - [🛠️ **Privacy Manifest Generator**](#-privacy-manifest-generator)
...
- [**Read here**](https://theswiftdev.com/)
...
- [**Read here**](https://fatbobman.com/en/)
...
- **Author:** Donny Wals
- **Tags:** ⭐ 🚀
- **Link:** [donnywals.com](https://www.donnywals.com/)
- [**Explore here**](https://www.donnywals.com/)
...
- [**Watch here**](https://www.youtube.com/@BrianAdvent)

### 🎥 **Building iOS Apps with Swift, TDD & Clean Architecture | Professional iOS Engineering Series**

- **Description:** This video series demonstrates Test-Driven Development (TDD) and clean architecture principles applied to iOS app development. It covers topics like Swift app prototyping, creating Swift frameworks, testing view controllers, powerful refactorings, and more.
- **Author:** Caio and Mike (Essential Developer)
- **Platform:** Youtube
- **Tags:** ⏱️ ⭐ 🚀
...
- **Author:** Ron Kliffer, Scott Gardner
- **Platform:** Kodeco
- **Tags:** ⏱️ ⭐ 🚀
- **Link:** <https://www.kodeco.com/10317653-calayer-tutorial-for-ios-getting-started>
- [**Read here**](https://www.kodeco.com/10317653-calayer-tutorial-for-ios-getting-started)
...
- **Description:** Reqres provides a convenient solution for front-end developers to test their applications against a real API. It offers fake data generation, real response codes, and 24/7 availability for free during development phases.
- **Author:** Ben Howdle
- **Tags:** 🚀
...
- **Description:** Mocky is the world's easiest and fastest tool to mock APIs. It allows you to generate custom API responses without waiting for the backend to be ready, enabling you to start working on your application immediately.
...
- **Description:** Quick reference tables, tools, and links for iOS developers. iOS Ref provides iOS compatibility tables, a comprehensive Swift cheatsheet, a hex code to UIColor converter, device screen resolution tables, and more.
- **Author:** Eugene Belinski
- **Tags:** ⭐ 🔄
...
- **Description:** Danger Swift is a tool for automating common code review tasks during CI processes. It allows teams to set up rules in Swift, which are then evaluated during code reviews, providing feedback directly within pull requests.
...
### 🛠️ **Swift AST Explorer**

- **Description:** Visualize Swift AST and select nodes within the editor, a great way to learn about the structure of Swift syntax trees.
- **Author:** [Kishikawa Katsumi](https://hachyderm.io/@kishikawakatsumi)
- **Tags:**
...
- **Description:** RocketSim provides various enhancements to the Xcode simulators, including the ability to compare designs, show rulers, add grids, and create recordings with touches and audio. It also allows for trimming and exporting recordings into MP4 or GIF formats.
...
- **Author:** [Kodeco](https://www.kodeco.com/)
- **Platform:** Github
- **Tags:** ⭐ 🚀
- **Link:** <https://github.com/kodecocodes/swift-algorithm-club>
- [**Explore here**](https://github.com/kodecocodes/swift-algorithm-club)

### 📂 **Design Patterns-In-Swift Repository**

- **Description:** This repository contains a collection of design patterns implemented in Swift 5.0. It covers a wide range of design patterns, including creational, structural, and behavioral patterns, each explained with examples and code snippets.
- **Author:** [Oktawian Chojnacki](https://oktawian.chojnacki.me/)
- **Platform:** GitHub
- **Tags:** ⭐ 🚀
- **Link:** <https://github.com/ochococo/Design-Patterns-In-Swift>
- [**Explore here**](https://github.com/ochococo/Design-Patterns-In-Swift)

### 📂 **SwiftUI Deliberate Practice Repository**

- **Description:** This repository contains a variety of SwiftUI projects aimed at deliberate practice, covering topics like animations, networking, navigation, controls, data flow, layout, Combine, CoreData, and more.
- **Author:** [Jonathan Rasmusson](https://github.com/jrasmusson)
- **Tags:** 🚀
- **Platform:** GitHub
- **Link:** <https://github.com/jrasmusson/swiftui>
- [**Explore here**](https://github.com/jrasmusson/swiftui)

### 🖊️ **Refactoring.Guru - Design Patterns in Swift**
...
- **Platform:** Medium
- **Tags:** 📅 ⭐ 🚀
- **Link:** <https://medium.com/@PavloShadov/best-resources-for-advanced-ios-developer-swift-ade30374593d>
- [**Read here**](https://medium.com/@PavloShadov/best-resources-for-advanced-ios-developer-swift-ade30374593d)

### 🎥 **Apple Developer Videos**

- **Description:** Explore more than one thousand in-depth videos on development, design, and business provided by Apple Developer. Customize your viewing experience with playback speeds, transcripts, code snippets, subtitles, and more.
- **Author:** Apple
- **Platform:** Apple
- **Tags:** 📅 ⭐ 🚀
